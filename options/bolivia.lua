...
function setup()
  return {
    properties = {
      ...
      u_turn_penalty                 = 60, -- increase value
      continue_straight_at_waypoint  = true,
      use_turn_restrictions          = true,
      left_hand_driving              = false,
      traffic_light_penalty          = 30, -- increase value
    },
    ...
    speeds = Sequence {
      highway = {
        motorway        = 60, -- decrease value
        motorway_link   = 30, -- decrease value
        trunk           = 40, -- decrease value
        trunk_link      = 25, -- decrease value
        primary         = 30, -- decrease value
        primary_link    = 20, -- decrease value
        secondary       = 20, -- decrease value
    ...
    surface_speeds = {
      ...
      sett = 40,
      grass_paver = 40,
      gravel = 15, -- decrease value
      unpaved = 20, -- decrease value
      ground = 40,
      dirt = 10, -- decrease value
      pebblestone = 40,
      tartan = 40,
